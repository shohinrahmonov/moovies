                ...
                {loading ? <Spin size="large" /> : ( selectedActor && <div className="movie-preview-container" >
                        ...
                        <Container className="custom-class-container">
                            <div className="movie-details">
                                ...
                                <p className="overview">{selectedActor.biography.length > 600 ? <>{selectedActor.biography.slice(0, 1000)} ... </> : selectedActor.biography} {selectedActor.imdb_id && <a href={`https://www.imdb.com/name/${selectedActor.imdb_id}`} target="_blank" rel="noopener noreferrer">Read more</a> }</p>
